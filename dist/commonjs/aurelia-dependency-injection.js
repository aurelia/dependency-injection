...
var Container = (function () {
    ...
    Container.prototype.registerSingleton = function (key, fn) {
        return this.registerResolver(key, new StrategyResolver(exports.Strategy.singleton, fn === undefined ? key : fn));
    };
    ...
    Container.prototype.registerHandler = function (key, handler) {
        return this.registerResolver(key, new StrategyResolver(exports.Strategy.function, handler));
    };
    ...
    Container.prototype.invoke = function (fn, dynamicDependencies) {
        try {
            ...
            throw new aureliaPal.AggregateError("Error invoking ".concat(fn.name, ". Check the inner error for details."), e, true);
        }
    };
